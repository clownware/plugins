...
| `clownware-code-tools` | Universal dev workflow skills: architecture auditing, security auditing, test-suite auditing, skill auditing, ADR authoring, PR descriptions, root-cause debugging, test scaffolding. | [`plugins/code-tools`](plugins/code-tools) |
